  ...
  return (
    <div className="Terms-Container">
      ...
      <p>
        ...
        of -s Website, located at -.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use - if you do not agree to take all of
      ...
      <p>
        ...
        Company's terms and conditions. The Company, Ourselves, We, Our and Us,
      ...
      <p>
        We employ the use of cookies. By accessing -, you agreed to use cookies
        in agreement with the -'s Privacy Policy.{}
      </p>
      ...
      <p>
        Unless otherwise stated, - and/or its licensors own the intellectual
        property rights for all material on -. All intellectual property rights
        are reserved. You may access this from - for your own personal use
      ...
      <p>
        ...
        of -,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, - shall not be liable for the Comments or
      ...
      <p>
        You hereby grant - a non-exclusive license to use, reproduce, edit and
      ...
      <p>
        ...
        the hyperlink compensates the absence of -; and (d) the link is in the
      ...
      <p>
        ...
        e-mail to -. Please include your name, your organization name, contact
      ...
      <p>
        No use of -'s logo or other artwork will be allowed for linking absent a
